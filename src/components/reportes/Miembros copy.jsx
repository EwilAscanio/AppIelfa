...
const styles = StyleSheet.create({
  ...
  tableColHeader: {
    width: "14%", // Ajusta los anchos para 5 columnas
  ...
  tableCol: {
    width: "15%", // Ajusta los anchos para 5 columnas
    padding: 10,
    textAlign: "center",
    fontSize: 8,
  },
        ...
        <View style={styles.section}>
          ...
          <View style={styles.table}>
            <View style={styles.tableRow}>
              ...
              <Text style={styles.tableColHeader}>Edad</Text>
              <Text style={styles.tableColHeader}>Tipo de Miembro</Text>
            </View>
            ...
            {asistencias && Array.isArray(asistencias) && asistencias.length > 0 ? (
              asistencias.map((miembro, index) => ( // Renombra 'item' a 'evento' para claridad
                <View key={miembro.cedula_mie || index} style={styles.tableRow}> {/* Usar codigo_eve como key */}
                  ...
                  <Text style={styles.tableCol}>{miembro.edad_actual} años</Text>
                  <Text style={styles.tableCol}>{miembro.tipo_mie}</Text>
                </View>
              ))
            ) : (
                <View style={styles.tableRow}>
          ...
          {asistencias && asistencias.length > 0 && (
            <Text style={styles.total}>
              Total de Personas: {totalAsistentes} {/* Usa totalAsistentes */}
            </Text>
          )}
        </View>
      </Page>
