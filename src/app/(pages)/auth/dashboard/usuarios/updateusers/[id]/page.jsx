  ...
  if (user === null) {
    return (
      ...
      <div className="flex flex-col items-center">
        <LuLoader2 className="animate-spin text-primary" size={50} />
    ...
    /*<div className="flex place-items-start p-4 min-h-screen bg-gray-100">
            <div className="bg-white rounded-lg shadow-xl sm:p-8 max-w-4xl w-full mx-auto text-center">
