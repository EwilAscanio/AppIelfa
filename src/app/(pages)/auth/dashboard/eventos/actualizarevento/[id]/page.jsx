...
const UpdateEvent = ({ params }) => {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((res) => {
        ...
        console.log("EVENT DATA LOADED AND FORMATTED", formattedEventData);
  ...
  const baseInputClass = "w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-700";
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-100">
        <div className="flex flex-col items-center">
          <LuLoader2 className="animate-spin text-blue-600" size={50} />
