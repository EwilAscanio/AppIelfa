...
const UpdateMembers = ({ params }) => {
  ...
  if (!member) return <div className="flex justify-center items-center min-h-screen text-gray-700">Cargando...</div>; // Estilo básico para carga
  ...
  return (
    <div className="flex justify-center place-items-start p-4 min-h-screen bg-gray-100"> {/* Ajustado a justify-center para centrar */}
      ...
      <div className="bg-white rounded-lg shadow-xl p-6 sm:p-8 max-w-4xl w-full"> {/* Ajustado padding y max-w */}
        {/* Título y subtítulo */}
