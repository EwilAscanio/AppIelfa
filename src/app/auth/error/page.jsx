      ...
      <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-lg text-center">
        ...
        <div className="mt-6">
          <Link href="/login" passHref>
            <button
              className="w-full flex items-center justify-center px-4 py-3 text-white font-semibold rounded-lg shadow-md transition-colors duration-300 bg-primary hover:bg-primary-hover"
            >
